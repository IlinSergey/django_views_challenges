...
class TestGetResponseFromGithubApi:
    def test__get_response_from_github_api__success(self):
        with patch(
    ...
    def test__get_response_from_github_api__not_found(self):
        with patch(
            'django_views_routing_homework.views.level_3.c_github_full_name.requests.get'
                ) as mock_get:
...
class TestFetchNameFromGithubView:
    ...
    @responses.activate
    def test__fetch_name_from_github_view__success(self, client, github_username,
                                                   expected_name, expected_result):
        responses.add(
            responses.GET,
    ...
    @responses.activate
    def test__fetch_name_from_github_view__with_not_name(self, client):
        responses.add(
            responses.GET,
    ...
    @responses.activate
    def test__fetch_name_from_github_view__not_found(self, client):
        responses.add(
            responses.GET,
            'https://api.github.com/users/IlyaLebedev',
            status=404
